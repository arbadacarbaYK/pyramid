...
`easy.sh` builds **Tailwind CSS** into the binary (`static/styles.css` is gitignored). A `go build` without that step 404s `/static/styles.css` and the dashboard looks like unstyled HTML. See [FORGE.md](./FORGE.md).
